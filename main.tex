...
\section{$\LMAMASS$}\label{sec:reach-lmamass}
\input{reach-lmamass.tex}

%======================================================================

\section{$\IFAMASS$}\label{sec:reach-ifamass}
\input{reach-ifamass.tex}

%======================================================================


\section{$\AMASS$}\label{sec:reach-amass}
...
an extended saturation procedure of {\PDS} to multiple stacks and a novel model of pushdown systems with well-partially-ordered transductions for which the reachability is shown to be decidable.
