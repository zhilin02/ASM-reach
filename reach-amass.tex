...
Let $(\aname'_1 \cdots \aname'_l, (\AutC_1, \cdots, \AutC_l)) \in \AutReach_B$ and $\alpha' = (\aname''_1 \cdots \aname''_m, (\AutD_1, \cdots, \AutD_m))$ such that $\aname''_1 \cdots \aname''_m$ is obtained from $\aname_2 \cdots \aname_k$ by removing those affinities from the set $\{\aname'_1, \cdots, \aname'_l\}$, and 
$(\AutD_1, \cdots, \AutD_m)$ is obtained from $(\AutB_2, \cdots, \AutB_k)$ by removing the {\WOTrNFA}'s for these affinities.  
Then we distinguish between whether an $A_0;\mhcancel{A_0};A_0$ switching is active or not. 
\begin{itemize}
