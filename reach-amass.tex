...
We prove Lemma~\ref{lem:amass-recog} by showing that $\RConfs(\Mm, \theta)$ can be \emph{saturated by repeatedly applying a finite set of rules}. 

Before presenting the rules, let us introduce several notations. 

Since $\TranSet_{A} = \TranSet_{\Mm}$, hence $\Pp_{A}$ is a {WOTrPDS}.
