...
\paragraph{Intuitions of the Intent flags}  We explain the intuitions of the five intent flags in the sequel. 
\begin{itemize}
...
We repeat the \textbf{Caveat} in Section~\ref{sect:semlmamass} for the intuition, introduce some additional functions and predicates. 
%\emph{Auxiliary functions and predicates.} 
Let $\rho$ be a configuration with $\rho = [A_1,\cdots,A_m]$.  
