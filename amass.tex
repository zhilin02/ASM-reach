...
The ultimate goal of the paper is to show the decidability of the configuration reachability problem of $\STK$-dominating $\AMASS$, which is stated in Theorem~\ref{thm:st-amass-reach}. 
